...
import IconComponent from "@/app/game/reusableComponents/iconComponent";
...
export default function OnlineTradeRowSection({ tradeDeck, tradeRow, explorerDeck, scrapPileCount, onSelectCard, onCardHover, onCardLeave, onCardClick, onViewTradeDeck }: TradeRowSectionProps) {
    return (
