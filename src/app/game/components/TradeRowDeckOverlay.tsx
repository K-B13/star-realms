...
interface TradeRowDeckOverlayProps {
    tradeDeck: string[];
    onClose: () => void;
}
...
export default function TradeRowDeckOverlay({tradeDeck, onClose}: TradeRowDeckOverlayProps) {
        ...
        >
            ...
            >
                ...
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-2xl font-bold text-cyan-300">Trade Deck</h3>
                    <button
                        onClick={onClose}
                ...
                <p className="text-gray-400 text-sm mb-6">
                    {tradeDeck.length} {tradeDeck.length === 1 ? 'card' : 'cards'} remaining
                </p>
                ...
                <div className="space-y-3">
                    {factionsInDeck.length === 0 ? (
                        <div className="text-center py-8">
                            <p className="text-gray-500 text-lg">Trade deck is empty</p>
                        </div>
                    ) : (
